...
@pytest.mark.xfail(reason="This is a current bug, but I've contrived the correct output for the test by disabling the deselect at the end and disabling the selection's border rendering.")
