...
- When a backup is automatically restored, and you say "No" to keeping the backup, it now restores the state before recovering the backup even if you make changes while the dialog is open.
